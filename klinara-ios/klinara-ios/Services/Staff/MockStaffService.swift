    ...
    func updateProfile(id: String, _ input: UpdateStaffProfileInput) async throws -> StaffProfile {
        ...
        return try withLock {
            ...
            let updated = StaffProfile(
                ...
                primaryBranchId: input.primaryBranchId.applied(to: old.primaryBranchId),
                branchIds: old.branchIds,
                title: input.title.applied(to: old.title),
                specialties: input.specialties ?? old.specialties,
                calendarColor: input.calendarColor.applied(to: old.calendarColor),
                bio: input.bio.applied(to: old.bio),
    ...
    func replaceSkills(id: String, _ input: ReplaceStaffServicesInput) async throws -> StaffProfile {
        ...
        return try withLock {
            ...
            let updated = StaffProfile(
                ...
                primaryBranchId: old.primaryBranchId, branchIds: old.branchIds, title: old.title,
