...
export const MESSAGES = {
  ...
  'block.contact.directions': 'Yol tarifi',
  'block.gallery.label': 'Fotoğraf galerisi',
  'block.gallery.prev': 'Önceki fotoğraflar',
  'block.gallery.next': 'Sonraki fotoğraflar',
  'nav.faq': 'SSS',
  'nav.menu': 'Sayfa bölümleri',
  'footer.rights': '© {year} {name}',
  'footer.poweredBy': 'Klinara ile online randevu',
