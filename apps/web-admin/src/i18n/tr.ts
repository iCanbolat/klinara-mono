...
export const MESSAGES = {
  ...
  'error.roleEscalation': 'Kendinizden yetkili bir rolü atayamaz veya kaldıramazsınız.',
  ...
  'reports.revenueHint': 'Dönemde tamamlanan hizmetlerin ve satılan paketlerin bedeli.',
  'reports.staffPerformance': 'Personel performansı',
  'reports.staffPerformanceHint': 'İşlem sayısı, ciro ve doluluk.',
  ...
  'staff.pageTitle': 'Şube ve Personel',
  'staff.pageDescription': 'Şubelerinizi, ekibinizin rollerini ve çalıştıkları şubeleri tek yerden yönetin.',
  'staff.tabStaff': 'Personel',
  'staff.tabBranches': 'Şubeler',
  'staff.tabInvites': 'Davetler',
  'staff.branchFilter': 'Şube',
  'staff.allBranches': 'Tüm şubeler',
  'staff.roles': 'Roller',
  'staff.branches': 'Şubeler',
  'staff.tenantWide': 'Kurum geneli',
  'staff.edit': 'Düzenle',
  'staff.editTitle': 'Personeli düzenle',
  'staff.profileSection': 'Profil',
  'staff.noPrimaryBranch': 'Ana şube yok',
  'staff.inaccessibleBranch': 'Erişiminiz olmayan bir şube',
  'staff.calendarColor': 'Takvim rengi',
  'staff.active': 'Aktif',
  'staff.activeHint': 'Pasif personel takvimde ve randevu sayfasında görünmez.',
  'staff.saveProfile': 'Profili kaydet',
  'staff.profileSaved': 'Profil kaydedildi.',
  'staff.primaryBranchHint': 'Takvimde ve raporlarda varsayılan şube.',

  'members.title': 'Roller ve şubeler',
  'members.description': 'Kişinin hangi şubede hangi rolle çalıştığı. Liste kaydedildiğinde TAMAMEN değiştirilir.',
  'members.role': 'Rol',
  'members.branch': 'Şube',
  'members.pickBranch': 'Şube seçin',
  'members.add': 'Rol ekle',
  'members.remove': 'Rolü kaldır',
  'members.save': 'Rolleri kaydet',
  'members.saved': 'Roller kaydedildi. Değişiklik hemen geçerli.',
  'members.empty': 'Bu kişinin klinikte rolü yok.',
  'members.noUserAccess': 'Rolleri görmek için kullanıcıları görüntüleme yetkiniz olmalı.',
  'members.readOnly': 'Rolleri görüntüleyebilirsiniz ama değiştiremezsiniz.',
  'members.lockSelf': 'Kendi rollerinizi değiştiremezsiniz; bunu sizden yetkili biri yapmalı.',
  'members.lockBranch':
    'Bu kişinin erişiminiz olmayan bir şubede de rolü var. Rolleri, tüm şubelerine erişimi olan biri düzenleyebilir.',
  'members.lockRank': 'Sizden yetkili bir rol — değiştirilemez.',
  'members.branchRequired': 'Bu rol için şube seçilmeli.',
  'members.duplicate': 'Bu rol bu şubede zaten var.',
  'members.removeAllTitle': 'Tüm roller kaldırılsın mı?',
  'members.removeAllBody': 'Kişi kliniğe erişimini tamamen kaybeder ve oturumu bir sonraki istekte kapanır.',
  'members.removeAllConfirm': 'Rolleri kaldır',
  'members.unsaved': 'Kaydedilmemiş rol değişikliği var',

  'branches.title': 'Şubeler',
  'branches.new': 'Yeni şube',
  'branches.edit': 'Şubeyi düzenle',
  'branches.name': 'Şube adı',
  'branches.slug': 'Şube kodu',
  'branches.slugHint': 'Randevu bağlantılarında görünür; küçük harf, rakam ve tire. Sonradan değiştirilemez.',
  'branches.timezone': 'Saat dilimi',
  'branches.phone': 'Telefon',
  'branches.address': 'Adres',
  'branches.active': 'Aktif',
  'branches.activeHint': 'Pasif şubede yeni randevu alınmaz; geçmiş kayıtlar korunur.',
  'branches.status': 'Durum',
  'branches.inactive': 'Pasif',
  'branches.empty': 'Henüz şube yok.',
  'branches.saved': 'Şube kaydedildi.',
  'branches.created': 'Şube oluşturuldu.',
  'branches.readOnly': 'Şubeleri yalnız işletme sahibi ekleyip düzenleyebilir.',
  'branches.deactivateTitle': 'Şube pasife alınsın mı?',
  'branches.deactivateBody':
    'Bu şubede yeni randevu alınamaz ve şube seçicilerden kalkar. Mevcut randevular, müşteriler ve raporlar korunur; şubeyi istediğiniz zaman yeniden aktif edebilirsiniz.',
  'branches.deactivateConfirm': 'Pasife al',
  'branches.staffCount': '{count} personel',

  'invites.title': 'Davetler',
  'invites.new': 'Personel davet et',
  'invites.email': 'E-posta',
  'invites.fullName': 'Ad Soyad',
  'invites.role': 'Rol',
  'invites.branch': 'Şube',
  'invites.expires': 'Son geçerlilik',
  'invites.sent': 'Davet gönderildi.',
  'invites.revoke': 'İptal et',
  'invites.revokeTitle': 'Davet iptal edilsin mi?',
  'invites.revokeBody': 'Bağlantı hemen geçersiz olur. Gerekirse yeniden davet gönderebilirsiniz.',
  'invites.revoked': 'Davet iptal edildi.',
  'invites.empty': 'Bekleyen davet yok.',
  'invites.expired': 'Süresi doldu',
  'invites.pending': 'Bekliyor',
  'invites.hint': 'Davet edilen kişi e-postadaki bağlantıyla parolasını belirleyip katılır.',
  'invites.devLink': 'Geliştirme bağlantısı',
  ...
  'schedule.noStaffHint': 'Personeli bu şubeye Şube ve Personel ekranından atayabilirsiniz.',
  'schedule.goToStaff': 'Şube ve Personel’e git',
  'schedule.branch': 'Şube',
  ...
  'customers.merge.description':
    'Seçilen kayıt arşivlenir; randevu, paket ve notları bu kayda taşınır. GERİ ALINAMAZ.',
  ...
  'editor.blockHint.hero': 'Sayfanın en üstündeki başlık, görsel ve randevu düğmesi.',
  'editor.blockHint.richText': 'Başlıklı serbest metin; kalın, liste ve bağlantı destekler.',
  'editor.blockHint.carousel': 'Kaydırılabilir fotoğraf şeridi.',
  'editor.blockHint.serviceList': 'Online randevuya açık hizmetler ve fiyatları.',
  'editor.blockHint.contact': 'Şube telefonları ve adresleri.',
  'editor.blockHint.map': 'Şube konumlarını gösteren harita.',
  'editor.blockHint.faq': 'Açılır kapanır soru–cevap listesi.',
  'faq.empty': 'Henüz soru eklenmedi.',
  'faq.add': 'Soru ekle',
  'faq.question': 'Soru',
  'faq.answer': 'Cevap',
  'faq.item': '{position}. soru',
  'faq.moveUp': '{position}. soruyu yukarı taşı',
  'faq.moveDown': '{position}. soruyu aşağı taşı',
  'faq.remove': '{position}. soruyu sil',
  'faq.full': 'En fazla {max} soru ekleyebilirsiniz.',
  'faq.questionRequired': 'Soru boş bırakılamaz.',
  'editor.addBlockAfter': 'Seçili bloğun altına eklenir.',
  'editor.addBlockEnd': 'Sayfanın sonuna eklenir.',
  'editor.removeTitle': '{block} bloğu silinsin mi?',
  'editor.removeBody': 'Blok taslaktan çıkarılır. Kaydetmeden önce sayfayı yeniden yükleyerek geri alabilirsiniz.',
  'editor.emptyTitle': 'Bir blok seçin',
  'editor.emptyBody': 'Soldaki listeden düzenlemek istediğiniz bölümü seçin ya da yeni bir blok ekleyin.',
  'editor.noBlocks': 'Sayfada henüz blok yok.',
  'editor.unsaved': 'Kaydedilmemiş değişiklik',
  'editor.savedAt': '{time} kaydedildi',
  'editor.saveShortcut': 'Kaydet (⌘S)',
  'editor.previewDesktop': 'Masaüstü önizleme',
  'editor.previewMobile': 'Mobil önizleme',
  'editor.previewReload': 'Önizlemeyi yenile',
  'editor.openLive': 'Yayındaki sayfayı aç',
  'editor.presets': 'Hazır paletler',
  'editor.hexInvalid': 'Geçerli bir renk kodu girin (ör. #0F766E).',
  'editor.seoHint': 'Arama sonuçlarında ve paylaşılan bağlantılarda görünür.',
  'editor.seoPreview': 'Arama sonucu önizlemesi',
  'editor.seoImage': 'Paylaşım görseli',
  'editor.charCount': '{count}/{max}',
  'asset.choose': 'Görsel seç',
  'asset.change': 'Değiştir',
  'asset.remove': 'Kaldır',
  'asset.libraryTitle': 'Görsel kütüphanesi',
  'asset.libraryDescription': 'Var olan bir görseli seçin ya da yenisini yükleyin.',
  'asset.dropzone': 'Dosyayı sürükleyip bırakın ya da seçmek için tıklayın',
  'asset.dropzoneHint': 'JPEG, PNG, WebP veya AVIF · en fazla {mb} MB',
  'asset.libraryEmpty': 'Kütüphanede henüz görsel yok.',
  'asset.missing': 'Görsel bulunamadı',
  'asset.select': '{name} görselini seç',
